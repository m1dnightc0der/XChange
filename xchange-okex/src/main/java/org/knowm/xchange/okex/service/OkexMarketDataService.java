...
public class OkexMarketDataService extends OkexMarketDataServiceRaw implements MarketDataService {
  ...
  public OrderBook getOrderBook(Instrument instrument, Object... args) throws IOException {
    ...
    return OkexAdapters.adaptOrderBook(
        getOkexOrderbook(OkexAdapters.adaptInstrumentToOkexInstrumentId(instrument), limitDepth), instrument);
  }
  ...
  public Trades getTrades(Instrument instrument, Object... args) throws IOException {
    ...
    return OkexAdapters.adaptTrades(
        getOkexTrades(OkexAdapters.adaptInstrumentToOkexInstrumentId(instrument), limitTrades).getData(), instrument);
  }
